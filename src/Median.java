...
public class Median {
	 ...
	 * Median.txt 
	 * 
	 * The goal of this problem is to implement the
	 * "Median Maintenance" algorithm (covered in the Week 5 lecture on heap
	 * applications). The text file contains a list of the integers from 1 to
	 ...
	 * kth median mk is defined as the median of the numbers x1,…,xk. (So, if k
	 * is odd, then mk is ((k+1)/2)th smallest number among x1,…,xk; if k is
